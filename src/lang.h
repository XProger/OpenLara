...
/* 24 */ , ""
/* 25 */ , ""
/* 26 */ , "АБВГДЕ~EЖЗИ{ИКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ@абвгде~eжзи{иклмнопрстуфхцчшщъыьэюя"//"Добро пожаловать ко мне домо{и. Я проведу небольшую экскурсию."
...
/* 31 */ , "Подо{идите к ящику и продолжая нажимать клафишу впер~ед нажима{ите клавишу де{иствия,@тогда я залезу на ящик."
