...
// Comment: Only tilde was used for double for long ö and ü
...
// TR1 subtitles
    ...
    "[53500]A testv)erek k~ozt az a h)ir j)arja, hogy a kolostor alatt@ker~ült s)irba  Tihocan,"
    "[60000]egyike az elveszett kontinens, Atlantisz,@ legend)as uralkod)oinak,"
    "[64500])es vele egy~ütt fekszik az +o darabja@az Atlantiszi Scion-nak."
    ...
    "[01500]El)it)elj~ük ~Ont, atlantiszi Natla a b+unei)ert."
    "[06000]Hatalmaddal er+oteljesen vissza)el)esei miatt,@ )es mert kiraboltad a mi..."
    "[11500]Nem tehetik! )En..."
    "[12500]Megsz~üntetve a beleegyez)es szabad k~otel)ek)et@amely alatt n)ep~ünket ir)any)itj)ak,"
    "[18500])es megt)amadva Tihocan-t )es engem a sereg~ünkkel."
    ...
    "[09500]Az evol)uci)o bajban van - a term)eszetes szelekci)o m)ara alig )erv)enyes~ül..."
    "[13500]Az )uj h)us megjelen)ese fel fogja ism)et gerjeszteni a ter~ületi vit)akat"
    ...
    "[45000]A m+uvelet sz)ive n)elk~ül nem!"
    "[47000]Neee!"
    "[50000]T)IZ"
    "[54000]~OT..."
    "[55500]4...3...2..."
    ...
    "[17000]V)arjunk... itt most a m+ut)argyr)ol besz)el~ünk?"
    ...
    "[19000]Ki Gyermek n)elk~ül halt meg )es a tud)as)anak nem volt ~or~ok~ose..."
    ...
    /* 44 */ , "Remek!@Ha nagy a m)elys)eg, )es nem szeretn)ek@s)er~ülni a leugr)assal, le tudom magam ereszteni )ovatosan."
    ...
    /* 46 */ , "Akkor engedd el."
    /* 47 */ , "Menj~ünk )uszni egyet."
    /* 48 */ , "Az ugr)as gomb )es az ir)anyok@navig)alnak engem a v)iz alatt."
    /* 49 */ , ")O! Leveg+o!@Csak haszn)ald az el+or)et, balr)at, vagy jobbr)at@a felsz)in k~ozeli man+overez)eshez.@Nyomj ugr)ast egy )ujabb )usz)ashoz lemer~ül)eshez.@Vagy menj a sz)el)ehez, )es nyomj akci)o gombot a kim)asz)ashoz."
