...
// TR1 subtitles
    ...
    "[138000]Cosa?"
    "[138500]Quella cosa.."
    "[140500]Sarà stato solo un pesce."
    ...
    "[20000]Siamo sulla buona strada ... te lo farò ingoi..."
    ...
    /* 29 */ , "Ora fallo di nuovo premendo un tasto direzionale;@salter$o verso quella parte."
    ...
    /* 32 */ , "Una volta questa era una sala da ballo@ma io l'ho trasformata nella mia palestra personale. Che te ne pare?@Ok, ora facciamo qualche esercizio."
    /* 33 */ , "Come immaginerai io non corro sempre;@quando serve una certa prudenza cammino.@Tieni premuto il tasto Camminata e raggiungi la linea bianca."
    ...
    /* 36 */ , "Se un salto $e troppo lungo posso aggrapparmi al bordo@per evitarmi una rovinosa caduta.@Cammina verso il bordo con la linea bianca finch)e non posso pi$u andare avanti;@quindi premi Salto, immediatamente seguito da Avanti@e mentre sono in aria premi e tieni premuto il tasto Azione."
    /* 37 */ , "Premi il tasto Avanti e mi arrampicher$o."
    /* 38 */ , "Facendo un salto con rincorsa arrivare a quella distanza@sarà sicuramente uno scherzo."
    /* 39 */ , "Cammina verso il bordo con la linea bianca finch)e non mi fermo.@Quindi rilascia il tasto Cammina e premi una volta Indietro@in modo da farmi prendere la rincorsa.@Premi Avanti e subito dopo premi e tieni premuto il tasto Salto:@non salterò fino all'ultimo secondo."
    /* 40 */ , "Perfetto; questo $e davvero un gran bel salto!@Allora: fai un salto con rincorsa esattamente come prima@ma questa volta mentre sono in aria premi e tieni premuto Azione@per permettermi di aggrapparmi al bordo."
    /* 41 */ , "Bene."
