...
/* 31 */ , "次はコンテナによじ登ってみましょう。@方向キーの上を押しながらxボタンを押して。"
/* 32 */ , "この部屋は私のジムよ。@どう？"
/* 33 */ , "R1キーを押しながら方向キーを押して、@白線のところまで歩いて。"
/* 34 */ , "R1ボタンを押していると、崖から落ちないわよ。"
/* 35 */ , "周りを見渡したいときはR1ボタンを押しながら、方向キーを押して。"
/* 36 */ , "まずは、白線のところまで歩いて、@□ボタンを押しながら、すぐに方向キーの上を押して、@空中にいるときにxボタンを押しっぱなしにすると、@フチにつかまれるわ。"
/* 37 */ , "xボタンを押したまま、上を押すと登れるわ。"
...
/* 40 */ , "そして次は最も重要なこと。@走りながらジャンプをして空中にいるとき、@xボタンだけを押し続けると崖のフチにつかまれるわ。"
/* 41 */ , "いいわ～　OK。"
/* 42 */ , "よじ登るにはxボタンを押したまま、方向キーの上を押して。"
/* 43 */ , "上のスペースが狭くて、ここからは登れないわ。@xボタンを押したまま、方向キーの右を押して、@右端まで行ったら、xボタンを押したまま、方向キーの上を押せば登れるわ。"
/* 44 */ , "いいわ～　もしケガをしたくなかったら、遺跡の中では注意深く行動することね。"
/* 45 */ , "自分の後ろに崖があるとき、@一度方向キーの下を押し、すぐにxボタンだけを押して、@崖のフチにぶら下がることもできるわ。"
/* 46 */ , "じゃあ、次に行きましょう。"
/* 47 */ , "次は泳ぎの練習ね。"
/* 48 */ , "□ボタンと方向キーを使って、@泳げるわ。"
/* 49 */ , "苦しかった～@方向キーの上、L2ボタンとR2ボタンで水上泳ぐことができるわ。@□ボタンでまた潜れるの。@プールのフチに行って、xボタンと方向キーの上を押すと水から上がれるわ。"
/* 50 */ , "そろそろ冒険に行きましょうか？"
/* 51 */ , "このメス犬が・・・！"
/* 52 */ , "こいつら一人一人紹介しねえとな。"
